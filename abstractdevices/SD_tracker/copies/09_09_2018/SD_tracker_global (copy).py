...
class SDTrackerGlobal(LabradServer):
    ...
    @setting(9, 'Get Fit History', client = 's', returns = '(*(v[s]v[gauss]) *(v[s]v[MHz]))')
    ...
    @setting(10, 'Get Excluded Points', client = 's', returns = '(*(v[s]v[gauss]) *(v[s]v[MHz]))')
    ...
    @setting(11, "Get Lines From Bfield and Center", B = 'v[gauss]', freq = 'v[MHz]', returns = '*(sv[MHz])')
