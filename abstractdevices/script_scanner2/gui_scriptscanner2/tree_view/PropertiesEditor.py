...
from .Data import SidebandElectorNode, SidebandElectorV2Node, DurationBandwidthNode, SpectrumSensitivityNode
...
from .editors.sideband_selection_v2_editor import sideband_selection_v2_editor
...
class PropertiesEditor(propBase, propForm):
    ...
    def __init__(self, parent = None):
        ...
        self._sideband_selection_v2_editor = sideband_selection_v2_editor(self)
        ...
        self._editors = [self._parametersEditor, self._scanEditor, self._stringEditor, 
                         ...
                         self._sideband_selection_editor, self._sideband_selection_v2_editor, self._DurationBandwidthEditor,
                         self._spectrum_sensitivity_editor, self._undefined_parameter_editor,
                         ]
    ...
    def setSelection(self, current, old):
        ...
        elif isinstance(node, SidebandElectorV2Node):
            self.show_only_editor(self._sideband_selection_v2_editor, current)
        ...
        elif isinstance(node, UndefinedParameterNode):
            self.show_only_editor(self._undefined_parameter_editor, current)
        else:
            for edit in self._editors:
                edit.setVisible(False)
