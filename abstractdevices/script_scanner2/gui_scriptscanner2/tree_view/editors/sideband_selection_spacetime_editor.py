...
path = os.path.join(basepath,"..","..","Views", "SidebandSelectionEditor_Spacetime.ui")
base, form = uic.loadUiType(path)

class sideband_selection_spacetime_editor(base, form):
    def __init__(self, parent=None):
        super(sideband_selection_spacetime_editor, self).__init__(parent)
        self.setupUi(self)
