class config_729_tracker(object):
    ...
    initial_selection = ['S-1/2D-3/2', 'S-1/2D-5/2'] # select these lines in the entry table at startup, has to be the name that is saved, i.e. instead of OP, S+1/2D-3/2
    initial_values = [-14.3, -19.3]
