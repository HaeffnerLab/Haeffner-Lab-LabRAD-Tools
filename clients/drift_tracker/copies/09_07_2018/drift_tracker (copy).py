    ...
    def update_track(self, meas, axes, lines):
        ...
        if (type(fitted)) == dict:
            ...
            if self.global_checkbox.isChecked():
                try:
                    ...
                    QtGui.QErrorMessage.qtHandler().showMessage('Global fit data points is none. You must include at least one data point.')
                ...
                try:
                    ...
                    QtGui.QErrorMessage.qtHandler().showMessage('Local line center fit data points is none. You must add at least one data point.')
        ...
        if (type(fitted)) == list:
            ...
            try:
                ...
                QtGui.QErrorMessage.qtHandler().showMessage('Local B field fit data points is none. You must add at least one data point.')
