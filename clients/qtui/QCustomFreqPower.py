...
class QCustomFreqPower(QtGui.QFrame):
    ...
    def makeLayout(self, title, switchable):
        ...
        self.spinFreq.setSizePolicy(QtGui.QSizePolicy.Minimum, QtGui.QSizePolicy.Fixed)
        self.spinPower.setSizePolicy(QtGui.QSizePolicy.Minimum, QtGui.QSizePolicy.Expanding)
