...
class experiment_selector_widget(QtWidgets.QWidget):
    ...
    def setupLayout(self):
        ...
        self.run_cont_button = QtWidgets.QPushButton("Run cont.")
    ...
    def connect_layout(self):
        ...
        self.dropdown.currentIndexChanged['QString'].connect(self.on_experiment_selected)
        self.dropdown.currentIndexChanged['QString'].connect(self.check_button_disable)
