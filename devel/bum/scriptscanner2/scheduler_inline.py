...
class scheduler(object):
    ...
    def launch_scripts(self, result = None):
        ...
        if should_launch:
            ...
            yield self.do_launch(ident, scan, priority, pause_running)
            self.launch_scripts()
...
#                print 'waiting to unfinish', ident
    ...
    def _add_to_running(self, ident, scan, status, priority):
        self.running[ident] = running_script(scan, None, status, priority)
