...
class NuvuVideo(QtGui.QWidget):
    def __init__(self, server):
        super(NuvuVideo, self).__init__()
    ...
    def setup_layout(self):
        ...
        self.emccdSpinBox.setMinimum(mingain)
        self.emccdSpinBox.setMaximum(maxgain)
        print maxgain
    ...
    def on_new_exposure(self, exposure):
        if self.live_update_loop.running:
            ...
            yield self.server.setExposureTime(None, exposure) #self.WithUnit(exposure,'s'))
