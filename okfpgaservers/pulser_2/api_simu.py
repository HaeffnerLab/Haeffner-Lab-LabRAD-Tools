...
from fpga_simu import fpga_simu

import connect_pmt as connect_pmt

import pmt_simu2

from twisted.internet.defer import returnValue, Deferred, inlineCallbacks

class api_simu(object):
    ...
    def __init__(self):
        ...
        self.pmt_simulator = pmt_simu2.pmt_simu()
    ...
    def connectOKBoard(self):
        ...
        print "Found {} unused simulated modules".format(module_count)
    ...
    def getReadoutCounts(self, number):
        ...
        #print "Returning PMT counts ..."
        buf = self.pmt_simulator.return_counts(number)
