...
class hardwareConfiguration(object):
    ...
    channelDict = {
                   ...
                   '729bichro':channelConfiguration(2, False, False, False, False),
                   '866_diff':channelConfiguration(3, False, True, True, False),
                   '729cw':channelConfiguration(4, False, False, False, False),
                   #------------sample CHANNELS----------------------------------------#
    ...
    ddsDict =   {
                 ...
                 # 'DDS_2':ddsConfiguration(    2,  (0.1,300.0),   (-63.0,-3.0),  41.0,   -63.0),
                 # 'DDS_3':ddsConfiguration(    3,  (0.1,300.0),   (-63.0,-3.0),  44.0,   -63.0),
                 # 'DDS_4':ddsConfiguration(    4,  (40.0,300.0),   (-63.0,-3.0),  46.0,   -63.0),
                 # 'DDS_5':ddsConfiguration(    5,  (40.0,300.0),   (-63.0,-3.0),  48.0,   -63.0),
                 # 'DDS_6':ddsConfiguration(    6,  (40.0,300.0),   (-63.0,-3.0),  56.0,   -63.0),
                 # 'DDS_7':ddsConfiguration(    7,  (40.0,300.0),   (-63.0,-3.0),  57.0,   -63.0),
